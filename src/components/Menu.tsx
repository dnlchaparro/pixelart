...
import { Pencil, PaintBucket, Sun, Moon, Pipette, Eraser } from "lucide-react";
...
export default function Menu({
  ...
  return (
    <div className="flex w-full sm:w-auto flex-col gap-2 items-start bg-light-panel dark:bg-dark-panel p-8 h-fit bit-border sm:ml-10 mb-10">
      ...
      />
      <div className="flex justify-between w-full mt-1 mb-8 pl-[5px]">
      ...
      <div className="flex gap-2 mb-13 mt-2 bit-border input p-1 bg-gray-200 dark:bg-gray-800 focus-within:outline focus-within:outline-2">
        <input
          type="text"
          value={hexInput}
      ...
      <div className="flex gap-8 mb-10">
        <button
          onClick={onClear}
          className="px-4 py-2 cursor-pointer bit-border red bg-red-500 text-white hover:bg-red-800 transition-colors"
        >
          Clear
        </button>
        <button
          onClick={onToggleGrid}
          className="px-4 py-2 cursor-pointer   bit-border blue bg-blue-500 text-white hover:bg-blue-800 transition-colors"
        >
